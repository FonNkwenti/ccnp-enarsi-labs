...
> Hands-on labs for the CCNP ENARSI (300-410) exam: *Implementing Cisco Enterprise Advanced Routing and Services*.
...
| | |
|---|---|
| **Exam** | CCNP ENARSI — Implementing Cisco Enterprise Advanced Routing and Services |
| **Code** | 300-410 |
| **Blueprint** | [`blueprint/300-410/blueprint.md`](blueprint/300-410/blueprint.md) |
| **Topics** | 9 (see [`specs/topic-plan.yaml`](specs/topic-plan.yaml)) |
| **Total labs (planned)** | ~47 |
...
```bash
cd labs/eigrp/lab-00-classic-adjacency/
...
```
ccnp-enarsi-labs/
├── blueprint/300-410/          Exam blueprint (source of truth for objectives)
...
- Cisco IOSv / IOSvL2 images loaded in EVE-NG (per topic requirements in `baseline.yaml`)
