# Fault Injection — DMVPN Lab 00: Phase 1 Hub-and-Spoke
...
```bash
python3 inject_scenario_01.py --host <eve-ng-ip>   # Ticket 1 — target: R2
python3 inject_scenario_02.py --host <eve-ng-ip>   # Ticket 2 — target: R3
python3 inject_scenario_03.py --host <eve-ng-ip>   # Ticket 3 — target: R1
```
